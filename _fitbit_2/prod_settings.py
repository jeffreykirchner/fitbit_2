...
#fitbit
FITBIT_MS_USERNAME = os.environ['FITBIT_MS_USERNAME']
FITBIT_MS_PASS = os.environ['FITBIT_MS_PASS']
FITBIT_MS_URL = os.environ['FITBIT_MS_URL']
FITBIT_MS_REGISTRATION = os.environ['FITBIT_MS_REGISTRATION']
FITBIT_TEST_ACCOUNT = os.environ['FITBIT_TEST_ACCOUNT']
