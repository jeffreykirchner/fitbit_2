    ...
    def get_download_summary_csv(self):
        ...
        with io.StringIO() as output:
            ...
            writer.writerow(["Session ID", "Pay Block Type", "Pay Block Number", "Period", "Player", "Note", "Recruiter ID", "Label", "Group", "Device", 
                            "Zone Minutes", "Zone Minutes From Heart Rate", "Average Block Zone Minutes", "Peak Minutes", "Cardio Minutes", "Fat Burn Minutes", "Out of Range Minutes", "Zone Minutes HR BPM Reported", "Zone Minutes HR BPM Expected", "Resting HR", "Age", "Wrist Time", 
